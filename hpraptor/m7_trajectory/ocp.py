...
from hpraptor.m5_propulsion.vehicles import get_vehicle, HybridVTOLConfig
from hpraptor.m5_propulsion.architecture_index import ContinuousArchitectureManager
from hpraptor.m6_dynamics.eom import TrajectoryDynamics
...
if __name__ == "__main__":
    ...
    solver = TrajectoryOCPSolver(
        ...
        dem_npz_path="data/dem/quito_cumbaya_corridor.npz",
